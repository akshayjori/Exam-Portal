...
<body>
	<a href="/welcome"><img id="backArrow" src="Img/backarrow.png"
		alt="Back"></a>

	<div class="mainContainer text-center">
		<h1>Which exam are you looking for?</h1>

		<form:form action="/searchexam" method="POST" modelAttribute="wrapper">
						...
						<tbody>
							...
							<c:forEach var="exam" items="${examsList}">
								<tr>
									...
									<td><a
										href="/takeexam?examCode=${exam.examCode}&userId=${userId}"
										class="btn btn-warning">Take Exam</a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
